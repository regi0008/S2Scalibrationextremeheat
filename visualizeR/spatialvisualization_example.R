...
#to get a subset of members (e.g. only members 1 to 4) using argument 'zcol':
...
#to plot multigrids, split data into monthly climo
...
#with contour lines added using argument contour=TRUE
spatialPlot(mg, backdrop.theme = "coastline",
            contour = TRUE,
            names.attr = c("DEC","JAN","FEB"),
            main = "mean climo 1991-2010",
