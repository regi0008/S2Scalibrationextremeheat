...
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,0]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,1]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,2]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,3]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,4]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,5]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,6]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,7]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,8]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,9]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,10]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,11]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,12]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,13]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,14]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,15]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,16]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,17]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,18]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,19]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,20]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,21]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,22]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,23]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,24]))
rmse(as.vector(obs$Data), as.vector(fcst$Data[,,,25]))